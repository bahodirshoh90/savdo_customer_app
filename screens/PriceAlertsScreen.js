...
export default function PriceAlertsScreen({ navigation, route }) {
  ...
  const handleAddAlert = async () => {
    ...
    try {
      ...
      Alert.alert('Xatolik', error.response?.data?.detail || error.message || 'Eslatma qo\'shishda xatolik');
    }
  };
  ...
  const handleDeleteAlert = async (alertId) => {
    try {
      ...
      Alert.alert('Xatolik', error.response?.data?.detail || 'Eslatmani o\'chirishda xatolik');
    }
  };
